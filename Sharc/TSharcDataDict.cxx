...
namespace ROOT {
   static void *new_TSharcData(void *p = nullptr);
   ...
   {
      ::TSharcData *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::TSharcData >(nullptr);
      static ::ROOT::TGenericClassInfo 
         instance("TSharcData", ::TSharcData::Class_Version(), "TSharcData.h", 31,
                  typeid(::TSharcData), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::TSharcData::Dictionary, isa_proxy, 16,
                  sizeof(::TSharcData) );
   ...
   {
      return GenerateInitInstanceLocal(static_cast<::TSharcData*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::TSharcData*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

//______________________________________________________________________________
atomic_TClass_ptr TSharcData::fgIsA(nullptr);  // static to hold class pointer
...
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TSharcData*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int TSharcData::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::TSharcData*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *TSharcData::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TSharcData*)nullptr)->GetClass();
   return fgIsA;
}
...
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TSharcData*)nullptr)->GetClass(); }
   return fgIsA;
}
...
namespace ROOT {
   ...
   static void delete_TSharcData(void *p) {
      delete (static_cast<::TSharcData*>(p));
   }
   static void deleteArray_TSharcData(void *p) {
      delete [] (static_cast<::TSharcData*>(p));
   }
...
namespace {
  void TriggerDictionaryInitialization_TSharcDataDict_Impl() {
...
#line 1 "TSharcDataDict dictionary forward declarations' payload"
#pragma clang diagnostic ignored "-Wkeyword-compat"
#pragma clang diagnostic ignored "-Wignored-attributes"
#pragma clang diagnostic ignored "-Wreturn-type-c-linkage"
extern int __Cling_AutoLoading_Map;
class __attribute__((annotate("$clingAutoload$TSharcData.h")))  TSharcData;
)DICTFWDDCLS";
    static const char* payloadCode = R"DICTPAYLOAD(
#line 1 "TSharcDataDict dictionary payload"
...
"TSharcData", payloadCode, "@",
nullptr
};
    static bool isInitialized = false;
    if (!isInitialized) {
      TROOT::RegisterModule("TSharcDataDict",
        headers, includePaths, payloadCode, fwdDeclCode,
        TriggerDictionaryInitialization_TSharcDataDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
  static struct DictInit {
    DictInit() {
      TriggerDictionaryInitialization_TSharcDataDict_Impl();
    }
  } __TheDictionaryInitializer;
}
void TriggerDictionaryInitialization_TSharcDataDict() {
  TriggerDictionaryInitialization_TSharcDataDict_Impl();
}
